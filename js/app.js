window.addEventListener("load", async () => {
  if (window.ethereum) {
    ...
    try {
      ...
      const contractAddress = "0x3097dF37e6F0FFc34Dcf6ce2bdc90F0984e4Ebb6";
      ...
      const maxPurchaseWei = await contract.methods.maxBnb(accounts[0]).call();

      const maxPurchase = web3.utils.fromWei(maxPurchaseWei, "ether");
      document.getElementById("maxPurchase").textContent = maxPurchase;

      const tokenContractAddress = "0x334eD8117A7cd5EfA17681093C3e66af61F877c1";
      ...
      const bnbBalanceWei = await web3.eth.getBalance(accounts[0]);
      const bnbBalance = web3.utils.fromWei(bnbBalanceWei, "ether");
      bnbBalanceElement.textContent = bnbBalance;
